...
(function () {
  ...
  },
  {
    ...
    options: [
      { text: '태극 1~8장을 마스터하고, 1품/1단 상징 품새인 [고려(高麗)] 품새를 절도 있게 구사할 수 있다.', target: 'DAN_1' },
      { text: '고려를 넘어, 2품/2단 상징 품새인 학다리 서기와 금강막기의 [금강(金剛)] 품새를 완습했다.', target: 'DAN_2' },
      { text: '금강을 넘어, 3품/3단 상징 품새인 금강세와 손날헤쳐막기의 [태백(太白)] 품새를 완숙히 시범할 수 있다.', target: 'DAN_3' },
      { text: '태백을 넘어, 4품/4단 고단자 품새인 [평원(平原)] 및 [지태(地苔)] 품새까지 완벽히 체득했다.', target: 'DAN_4' }
    ]
  },
  {
    id: 14,
